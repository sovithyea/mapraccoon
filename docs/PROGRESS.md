...
| 3 | Friends platform | ✅ spec + plan | `phase/3-friends` | Vithyea | **In progress** — steps 0–3 done (deletions, fixtures, hours, schema + neighbourhoods). Steps 4–10 remain; step 7 needs Supabase (B10) |
