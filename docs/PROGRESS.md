...
| 3 | Friends platform | ✅ spec + plan | `phase/3-friends` | Vithyea | **In progress** — steps 0–4 done. Steps 5–10 remain; step 5 (venue content) is the long pole and step 7 needs Supabase (B10) |
