...
| 2 | Itinerary builder | `specs/2-itinerary/` | Multi-stop route building, travel time via Mapbox Directions, stop reordering via Optimization API, held client-side in Zustand + localStorage | 1 |
